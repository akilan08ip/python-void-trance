...
const PythonChatbot = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "bot", content: "🐍 Hi! I'm your Python Guide. Ask me anything about Python – values, scopes, career paths, basic programs, or learning roadmaps!" },
  ]);
        ...
        {open && (
          ...
          >
            ...
            <div className="px-3 pb-1 flex gap-1 flex-wrap">
              {["Basic programs", "Learn Python", "Career", "Next steps"].map((q) => (
                <button
                  key={q}
                  onClick={() => { setInput(q); }}
